...
/*********************************************************************************/
#ifndef SCREEN_FLOW_5VIEWBASE_HPP
#define SCREEN_FLOW_5VIEWBASE_HPP
...
class screen_flow_5ViewBase : public touchgfx::View<screen_flow_5Presenter>
{
public:
    screen_flow_5ViewBase();
    virtual ~screen_flow_5ViewBase();
    ...
    {
        // Override and implement this function in screen_flow_5
    }
...
protected:
    ...
    touchgfx::TextButtonStyle< touchgfx::BoxWithBorderButtonStyle< touchgfx::ClickButtonTrigger >  >  btn_1_version;
    touchgfx::TextButtonStyle< touchgfx::BoxWithBorderButtonStyle< touchgfx::ClickButtonTrigger >  >  btn_2_brightness;
    touchgfx::TextButtonStyle< touchgfx::BoxWithBorderButtonStyle< touchgfx::ClickButtonTrigger >  >  btn_3_language;
    touchgfx::TextButtonStyle< touchgfx::BoxWithBorderButtonStyle< touchgfx::ClickButtonTrigger >  >  btn_4_appearance;
...
private:
     ...
     */
    touchgfx::Callback<screen_flow_5ViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<screen_flow_5ViewBase, const touchgfx::Slider&, int> sliderValueChangedCallback;
...
#endif // SCREEN_FLOW_5VIEWBASE_HPP

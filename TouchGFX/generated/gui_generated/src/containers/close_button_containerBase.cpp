...
close_button_containerBase::close_button_containerBase() :
    flexButtonCallback(this, &close_button_containerBase::flexButtonCallbackHandler)
{
    setWidth(320);
    setHeight(240);
    ...
    textArea.setTypedText(touchgfx::TypedText(T_CLOSE_CONTAINER_TEXT_INFO));
    ...
    cancel_button.setText(TypedText(T_CLOSE_CONTAINER_BTN_CANCEL));
    ...
    confirm_button.setText(TypedText(T_CLOSE_CONTAINER_BTN_CLOSE));
...
void close_button_containerBase::initialize()
{

}

void close_button_containerBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &cross_button)
    {
        //Interaction1

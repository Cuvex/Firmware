 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
keyboardPlainText_container::keyboardPlainText_container(): keyboard(), modeBtnTextArea(), submodeBtnTextArea(), capslockPressed(this, &keyboardPlainText_container::capslockPressedHandler), backspacePressed(this, &keyboardPlainText_container::backspacePressedHandler),
modePressed(this, &keyboardPlainText_container::modePressedHandler), keyPressed(this, &keyboardPlainText_container::keyPressedhandler), alphaKeys(true), uppercaseKeys(false), firstCharacterEntry(false)
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::initialize()
{
    keyboardPlainText_containerBase::initialize();
}
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::setKeyMappingList()
{
	if(alphaKeys == true)
	{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::backspacePressedHandler()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::capslockPressedHandler()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::modePressedHandler()
{
	alphaKeys = !alphaKeys;
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::keyPressedhandler(Unicode::UnicodeChar keyChar)
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::setTouchable(bool touch)
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
Unicode:: UnicodeChar* keyboardPlainText_container::getBuffer()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void keyboardPlainText_container::clearBuffer()
{

...
decrypt_tag::decrypt_tag(): num_pwd_errors(0), num_pwds(0), actual_pwd(0), pwd_ok(0), pwds{0}, pwd_raw{0}, pwd_sha256{0}, pwd_combined_sha256{0}, header_aes_gcm{0}, iv_aes_gcm{0}
{

 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
keyboardPassword_container::keyboardPassword_container(): keyboard(), modeBtnTextArea(), submodeBtnTextArea(), capslockPressed(this, &keyboardPassword_container::capslockPressedHandler), backspacePressed(this, &keyboardPassword_container::backspacePressedHandler),
modePressed(this, &keyboardPassword_container::modePressedHandler), keyPressed(this, &keyboardPassword_container::keyPressedhandler), alphaKeys(true), uppercaseKeys(false), firstCharacterEntry(false)
{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::initialize()
{
    keyboardPassword_containerBase::initialize();
}
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::setKeyMappingList()
{
	if(alphaKeys == true)
	{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::backspacePressedHandler()
{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::capslockPressedHandler()
{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::modePressedHandler()
{
	alphaKeys = !alphaKeys;
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::keyPressedhandler(Unicode::UnicodeChar keyChar)
{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::setTouchable(bool touch)
{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
Unicode:: UnicodeChar* keyboardPassword_container::getBuffer()
{
 ...
 ***** Respuesta 	: N/A
 **************************************************************************************************************************************/
void keyboardPassword_container::clearBuffer()
{

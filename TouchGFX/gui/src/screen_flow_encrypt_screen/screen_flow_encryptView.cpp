...
screen_flow_encryptView::screen_flow_encryptView(): text_type(0), total_words(0), actual_word(0), index_words(0), valid_word(0), actual_pwd(0), total_pwds(1), mandatory_pwds(1), flag_refresh_text_area(0), words_to_encrypt{0}, words_to_check{0}, buff_passphrase{0}, buff_plain_text{0}, pwds{0}, pwd_raw{0}, pwd_sha256{0}, pwd_combined_sha256{0}, header_aes_gcm{0}, iv_aes_gcm{0}
{

}

void screen_flow_encryptView::setupScreen()
{
    screen_flow_encryptViewBase::setupScreen();
    screen_flow_encryptView::setScreenMode();
    screen_flow_encryptView::setScreenLanguage();
    screen_flow_encryptView::changeScreen(GUI_TO_MAIN_SCREEN_FLOW_ENCRYPT);
...
void screen_flow_encryptView::tearDownScreen()
{
    screen_flow_encryptViewBase::tearDownScreen();
    screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_DISABLE);
}
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::tickEventScreen()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::changeScreen(uint8_t screen)
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::changeStateNfc(uint8_t state)
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::updateStateNfc(uint16_t state)
{
	switch(state)
	{
	...
	case MAIN_TO_GUI_NFC_INITIALIZED:
		if(s5_initNFC.isVisible())
		{
			...
			if(total_pwds != mandatory_pwds){
				screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_TAG_READ_WRITE_FLOW_ENCRYPT_T4T_8K);
			}
			else{
				screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_TAG_READ_WRITE_FLOW_ENCRYPT);
			}
		}
		else if(s1_fromNFC_1_initNFC.isVisible())
		{
			...
			screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_TAG_READ_FROM_NFC);
		}
		break;
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::hideKeyboard1SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::showKeyboard1SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::enterKeyboard1SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::hideKeyboard2SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::showKeyboard2SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::enterKeyboard2SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::hideKeyboard3SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::showKeyboard3SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::enterKeyboard3SeedPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::hideKeyboardPlainTextPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::showKeyboardPlainTextPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::enterKeyboardPlainTextPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::hideKeyboardPasswordPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::show1KeyboardPasswordPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::show2KeyboardPasswordPressed()
{
	text_info_1_password.setPosition(0, 10, 320, 20);
	text_info_2_password.setPosition(0, 102, 320, 13);
	keyboard1_text_typed_hide_password.setPosition(76, 40, 160, 20);
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::enterKeyboardPasswordPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::hideKeyboardAliasPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::showKeyboardAliasPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::enterKeyboardAliasPressed()
{
	if(keyboard_text_typed_aliasBuffer[0] != 0x00)
	{
		/*** Generation of the records data ***/
		screen_flow_encryptView::generateRecordData1_Alias();
		screen_flow_encryptView::generateRecordData2_Cryptogram();
		screen_flow_encryptView::generateRecordData3_Information();

		if(total_pwds != mandatory_pwds){
			screen_flow_encryptView::generateRecordData4_Multisignature();
		}
		...
		screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_ENABLE);
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::menuBip39Pressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::menuSlip39Pressed()
{
	/*** Update variable of type of text to encrypt ***/
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::menuXmrPressed()
{
	/*** Update variable of type of text to encrypt ***/
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::menuPlainTextPressed()
{
	/*** Update variable of type of text to encrypt ***/
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::menuTextFromNfcPressed()
{
	/*** Enabling NFC to allow reading/writing ***/
	screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_ENABLE);
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::encryptPressed()
{
	/*** Selecting visible/hidden elements on the screen ***/
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::successPressed()
{
	NVIC_SystemReset();
}
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::eye1Pressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::eye2Pressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::retryPressed()
{
	/*** Enabling NFC to allow reading/writing ***/
	screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_ENABLE);
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::passwordSuccessPressed()
{
	actual_pwd++;
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::multisignedYesPressed()
{
	/*** Selecting visible/hidden elements on the screen ***/
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::multisignedNoPressed()
{
	/*** Selecting visible/hidden elements on the screen ***/
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::multisignedPlusPressed()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::multisignedMinusPressed()
{
	Unicode::UnicodeChar aux_str[5] = {0};
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::multisignedSelectPressed()
{
	Unicode::UnicodeChar degree[] = {0x00B0,0};
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::btnUpPressed()
{
	uint8_t aux = 0;
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::btnDownPressed()
{
	uint8_t num_of_lines = 0;
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::btnScrollUpPressed()
{
	switch(text_type)
	{
	case TEXT_TYPE_NONE:
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::btnScrollDownPressed()
{
	switch(text_type)
	{
	case TEXT_TYPE_NONE:
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::btnFromNfcErrorPressed()
{
	/*** Enabling NFC to allow reading/writing ***/
	screen_flow_encryptView::changeStateNfc(GUI_TO_MAIN_NFC_ENABLE);
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::setScreenMode()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::setScreenLanguage()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::generateRecordData1_Alias()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::generateRecordData2_Cryptogram()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::generateRecordData3_Information()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::generateRecordData4_Multisignature()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::configAESPeripheral(uint8_t keyAES[], uint8_t ivAES[])
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::checkDataFromNFC()
{
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_encryptView::generateCombinations(int start, int index, char comb_buffer[][KEYBOARD1_TEXT_TYPED_PASSWORD_SIZE])
{

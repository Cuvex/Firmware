...
#ifndef KEYBOARD_ENCRYPT_PASSWORD2_HPP
#define KEYBOARD_ENCRYPT_PASSWORD2_HPP

#include <gui_generated/containers/keyboard_encrypt_password2Base.hpp>
...
class keyboard_encrypt_password2 : public keyboard_encrypt_password2Base
{
public:
    keyboard_encrypt_password2();
    virtual ~keyboard_encrypt_password2() {}
...
protected:
    ...
    Callback<keyboard_encrypt_password2> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_encrypt_password2> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_encrypt_password2> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_encrypt_password2, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_ENCRYPT_PASSWORD2_HPP

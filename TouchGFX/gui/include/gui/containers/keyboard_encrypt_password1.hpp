...
#ifndef KEYBOARD_ENCRYPT_PASSWORD1_HPP
#define KEYBOARD_ENCRYPT_PASSWORD1_HPP

#include <gui_generated/containers/keyboard_encrypt_password1Base.hpp>
...
class keyboard_encrypt_password1 : public keyboard_encrypt_password1Base
{
public:
    keyboard_encrypt_password1();
    virtual ~keyboard_encrypt_password1() {}
...
protected:
    ...
    Callback<keyboard_encrypt_password1> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_encrypt_password1> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_encrypt_password1> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_encrypt_password1, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_ENCRYPT_PASSWORD1_HPP

...
#ifndef KEYBOARDDEVICEALIAS_CONTAINER_HPP
#define KEYBOARDDEVICEALIAS_CONTAINER_HPP
...
class keyboardDeviceAlias_container : public keyboardDeviceAlias_containerBase
{
public:
    keyboardDeviceAlias_container();
    virtual ~keyboardDeviceAlias_container() {}
...
protected:
    ...
    Callback<keyboardDeviceAlias_container> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboardDeviceAlias_container> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboardDeviceAlias_container> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboardDeviceAlias_container, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARDDEVICEALIAS_CONTAINER_HPP

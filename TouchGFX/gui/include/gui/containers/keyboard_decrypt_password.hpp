...
#ifndef KEYBOARD_DECRYPT_PASSWORD_HPP
#define KEYBOARD_DECRYPT_PASSWORD_HPP

#include <gui_generated/containers/keyboard_decrypt_passwordBase.hpp>
...
class keyboard_decrypt_password : public keyboard_decrypt_passwordBase
{
public:
    keyboard_decrypt_password();
    virtual ~keyboard_decrypt_password() {}
...
protected:
    ...
    Callback<keyboard_decrypt_password> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_decrypt_password> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_decrypt_password> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_decrypt_password, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_DECRYPT_PASSWORD_HPP

...
#ifndef KEYBOARDPASSPHRASE_CONTAINER_HPP
#define KEYBOARDPASSPHRASE_CONTAINER_HPP
...
class keyboardPassphrase_container : public keyboardPassphrase_containerBase
{
public:
    keyboardPassphrase_container();
    virtual ~keyboardPassphrase_container() {}
...
protected:
    ...
    Callback<keyboardPassphrase_container> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboardPassphrase_container> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboardPassphrase_container> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboardPassphrase_container, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARDPASSPHRASE_CONTAINER_HPP

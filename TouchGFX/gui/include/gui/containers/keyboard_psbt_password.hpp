...
#ifndef KEYBOARD_PSBT_PASSWORD_HPP
#define KEYBOARD_PSBT_PASSWORD_HPP

#include <gui_generated/containers/keyboard_psbt_passwordBase.hpp>
...
class keyboard_psbt_password : public keyboard_psbt_passwordBase
{
public:
    keyboard_psbt_password();
    virtual ~keyboard_psbt_password() {}
...
protected:
    ...
    Callback<keyboard_psbt_password> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_psbt_password> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_psbt_password> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_psbt_password, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_PSBT_PASSWORD_HPP

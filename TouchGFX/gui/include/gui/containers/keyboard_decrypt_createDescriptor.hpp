...
#ifndef KEYBOARD_DECRYPT_CREATEDESCRIPTOR_HPP
#define KEYBOARD_DECRYPT_CREATEDESCRIPTOR_HPP

#include <gui_generated/containers/keyboard_decrypt_createDescriptorBase.hpp>
...
class keyboard_decrypt_createDescriptor : public keyboard_decrypt_createDescriptorBase
{
public:
    keyboard_decrypt_createDescriptor();
    virtual ~keyboard_decrypt_createDescriptor() {}
...
protected:
    ...
    Callback<keyboard_decrypt_createDescriptor> backspacePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_decrypt_createDescriptor, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_DECRYPT_CREATEDESCRIPTOR_HPP

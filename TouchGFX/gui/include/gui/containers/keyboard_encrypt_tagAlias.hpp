...
#ifndef KEYBOARD_ENCRYPT_TAGALIAS_HPP
#define KEYBOARD_ENCRYPT_TAGALIAS_HPP

#include <gui_generated/containers/keyboard_encrypt_tagAliasBase.hpp>
...
class keyboard_encrypt_tagAlias : public keyboard_encrypt_tagAliasBase
{
public:
    keyboard_encrypt_tagAlias();
    virtual ~keyboard_encrypt_tagAlias() {}
...
protected:
    ...
    Callback<keyboard_encrypt_tagAlias> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_encrypt_tagAlias> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_encrypt_tagAlias> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_encrypt_tagAlias, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_ENCRYPT_TAGALIAS_HPP

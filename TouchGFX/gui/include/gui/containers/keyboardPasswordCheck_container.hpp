...
#ifndef KEYBOARDPASSWORDCHECK_CONTAINER_HPP
#define KEYBOARDPASSWORDCHECK_CONTAINER_HPP
...
class keyboardPasswordCheck_container : public keyboardPasswordCheck_containerBase
{
public:
    keyboardPasswordCheck_container();
    virtual ~keyboardPasswordCheck_container() {}
...
protected:
    ...
    Callback<keyboardPasswordCheck_container> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboardPasswordCheck_container> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboardPasswordCheck_container> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboardPasswordCheck_container, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARDPASSWORDCHECK_CONTAINER_HPP

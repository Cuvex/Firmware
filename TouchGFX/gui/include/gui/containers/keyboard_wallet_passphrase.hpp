...
#ifndef KEYBOARD_WALLET_PASSPHRASE_HPP
#define KEYBOARD_WALLET_PASSPHRASE_HPP

#include <gui_generated/containers/keyboard_wallet_passphraseBase.hpp>
...
class keyboard_wallet_passphrase : public keyboard_wallet_passphraseBase
{
public:
    keyboard_wallet_passphrase();
    virtual ~keyboard_wallet_passphrase() {}
...
protected:
    ...
    Callback<keyboard_wallet_passphrase> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_wallet_passphrase> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_wallet_passphrase> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_wallet_passphrase, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_WALLET_PASSPHRASE_HPP

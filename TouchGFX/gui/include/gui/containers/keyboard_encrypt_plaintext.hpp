...
#ifndef KEYBOARD_ENCRYPT_PLAINTEXT_HPP
#define KEYBOARD_ENCRYPT_PLAINTEXT_HPP

#include <gui_generated/containers/keyboard_encrypt_plaintextBase.hpp>
...
class keyboard_encrypt_plaintext : public keyboard_encrypt_plaintextBase
{
public:
    keyboard_encrypt_plaintext();
    virtual ~keyboard_encrypt_plaintext() {}
...
protected:
    ...
    Callback<keyboard_encrypt_plaintext> capslockPressed;

    /*** Callback for the backspace button ***/
    Callback<keyboard_encrypt_plaintext> backspacePressed;

    /*** Callback for the keyboard mode button ***/
    Callback<keyboard_encrypt_plaintext> modePressed;

    /*** Callback for when keys are pressed on the keyboard ***/
    Callback<keyboard_encrypt_plaintext, Unicode::UnicodeChar> keyPressed;
...
#endif // KEYBOARD_ENCRYPT_PLAINTEXT_HPP

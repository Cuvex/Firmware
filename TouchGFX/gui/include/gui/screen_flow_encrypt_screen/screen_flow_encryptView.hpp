...
#ifndef SCREEN_FLOW_ENCRYPTVIEW_HPP
#define SCREEN_FLOW_ENCRYPTVIEW_HPP

#include <gui_generated/screen_flow_encrypt_screen/screen_flow_encryptViewBase.hpp>
#include <gui/screen_flow_encrypt_screen/screen_flow_encryptPresenter.hpp>
#include <texts/TextKeysAndLanguages.hpp>

class screen_flow_encryptView : public screen_flow_encryptViewBase
{
public:
	screen_flow_encryptView();
	virtual ~screen_flow_encryptView() {}
...
#endif // SCREEN_FLOW_ENCRYPTVIEW_HPP
